...
sealed class TablesScreenUiState{
    data object EmptySearchState: TablesScreenUiState()
    ...
    data class FilteredFoodsByCategory(val filteredFoodList: List<FoodItemUiModel>, val categoriesList:List<CategoryUiModel>): TablesScreenUiState()
        data class SearchedFoodsByName(val searchedFoodList: List<FoodItemUiModel>, val categoriesList:List<CategoryUiModel>): TablesScreenUiState()
